...
namespace AdminLogin
{
    public partial class DangNhap : Form
    {
        ...
        private void button_DangNhap_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (modify.TaiKhoans(query).Count() != 0)
                {
                    ...
                    this.Hide();
                    //update
                    string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\84967\OneDrive\Documents\GitHub\LoginGame\AdminLogin\Database1.mdf;Integrated Security=True";
                    string jsonFilePath = @"C:\Users\84967\OneDrive\Documents\GitHub\LoginGame\AdminLogin\bin\Debug\AnotherUEHSaveFile";
                    ...
                    Process.Start(@"C:\Users\84967\Downloads\Game_1\NOZ_C.exe");
                }
        ...
        private void UpdateDatabaseFromTextDataAndSaveToFile(string tentk, string textData)
        {
            try
            {
                string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\84967\OneDrive\Documents\GitHub\LoginGame\AdminLogin\bin\Debug\Database1.mdf"";Integrated Security=True";
